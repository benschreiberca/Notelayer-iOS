...
| --- | --- | --- | --- | --- | --- |
| A | Feature gate core + Insights visibility gate | `codex/prd01-03-gating` | `PRD_01_Experimental_Features_Framework_plan.md`, `PRD_03_Analytics_Insights_Toggle_plan.md` | 🟥 HOLD | 1 |
