    ...
    extend: {
      ...
      colors: {
        ...
        priority: {
          ...
          deferred: "hsl(var(--priority-deferred))",
        },
        category: {
          house: "hsl(var(--category-house))",
          garage: "hsl(var(--category-garage))",
          printing: "hsl(var(--category-printing))",
      ...
      boxShadow: {
        ...
        'elevated': '0 8px 24px -8px rgba(0, 0, 0, 0.12), 0 2px 8px -2px rgba(0, 0, 0, 0.08)',
